...
/////////////////
const BotName = 'Arikkunメ|Bot'; 
const Instagram = 'https://www.instagram.com/arikkun029/https://www.instagram.com/arikkun029/'; 
const Facebook = 'https://t.me/reuzzz'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://youtube.com/YoutuberGanteng
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:https://www.instagram.com/arikkun029/')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:https://www.instagram.com/arikkun029/`)
})
